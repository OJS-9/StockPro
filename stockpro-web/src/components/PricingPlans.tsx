...
export default function PricingPlans({
  ...
  const handleUpgrade = async (tier: 'starter' | 'ultra') => {
    // On the public /pricing page, send users into the app — they'll sign in
    // (if needed) and finish the checkout from Settings.
    if (!compact) {
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: compact ? 20 : 28 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: compact ? 'repeat(auto-fit, minmax(220px, 1fr))' : 'repeat(auto-fit, minmax(260px, 1fr))', gap: 16 }}>
        <PlanCard
          name="Free"
          price={0}
          cadence={cadence}
